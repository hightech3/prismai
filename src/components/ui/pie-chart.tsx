...
class PieChartComponent extends PureComponent<PieChartComponentProps, PieChartComponentState> {
    state: PieChartComponentState = {
        activeIndex: 0,
    };
    ...
    render() {
        ...
        return (
            <ResponsiveContainer className={'w-full'} height={500}>
                <PieChart width={500} height={500} title='Pie Chart'>
                    <Pie
